package com.copote.common.constant;
...
public class PayConstant {
	 ...
	 * 交易关闭
	 */
	public final static byte TRADE_STATUS_CLOSED = 3;

	/**
	 * 订单退款
	 */
	public final static byte TRADE_STATUS_REFUNDED = 3;
	/**
	 * 订单过期
	 */
	 ...
	 * 转账中
	 */
	public final static byte TRANS_STATUS_TRANING = 1;
	/**
	 * 成功
	 */
	 ...
	 * 确认成功
	 */
	public final static byte TRANS_RESULT_SUCCESS = 2;
	/**
	 * 确认失败
	 */
	...
	public static final String RESULT_VALUE_FAIL = "FAIL";
